import { RENDER_URL, STRIPE_API_KEY, RAILWAY_URL } from "../config/config.js";
...
export const createPaymentsController = async (req, res) => {
  try {
    ...
    const sessions = await stripe.checkout.sessions.create({
      ...
      success_url: `${RENDER_URL}/api/payments/success`,
      cancel_url: `${RENDER_URL}/api/payments/cancel`,
    });
